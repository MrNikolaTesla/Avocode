...
<head>
    ...
    <script>
        //Script para moverse entre las distintas secciones de la Cartilla
        (function($) {
                ...
                <div class="table-title">
                    <div class="row">
                        ...
                        <table class="table table-bordered">
                            ...
                            <!-- APARTADO QUE ABARCA MENÚ Y SECCIONES-->
                                            ...
                                            <div id="menu-wrapper">
                                                <div class="breakfast menu-restaurant">
                                                    <div class="clearfix">
                                                        ...
                                                        <a><img class="imagen-cartilla" src="<?php echo $dir_imagen; ?>" alt="Imagen" width="120" height="80"></a>
                                                        <?php require("controlador/ControladorBotonParaAgregarAOrden.php"); ?>

                                                        <a class="menu-title" data-meal-img=".jpg"><?php echo $producto['nombre'] ?></a>
                                        ...
                                        <div class="col-md-4 col-sm-4 mr-15">
                                            ...
                                            <div class="media-2">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="light-blue regular alt-p"> Martes a Sabados de 20 a 00 hs</p>
