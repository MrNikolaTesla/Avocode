    ...
    <input class="input-cartilla" type="number" width="10"></input>
    ...
    <a href="controlador/Controlador_Agregar_A_Orden.php?id=<?php echo $producto['id_producto'] ?>"><button>IDK!</button></a>