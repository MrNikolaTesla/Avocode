...
<body>
    <form method="POST">
        <section class="form-register">
            ...
            <input class="controls" type="password" name="passwordReg1" id="password" placeholder="Ingrese su Contraseña"></input>
            <input class="controls" type="password" name="passwordReg2" id="password" placeholder="Ingrese su Contraseña"></input>
