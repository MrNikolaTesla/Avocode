...
<body>
<form method="POST" action="Modelo_RegistroSesion.php">
  <section class="form-register">
    ...
    <input class="" type="password" name="passwordRegistro1" id="contraseña" placeholder="Ingrese su Contraseña"></input>
    <input class="" type="password" name="passwordRegistro2" id="contraseña" placeholder="Ingrese su Contraseña"></input>
